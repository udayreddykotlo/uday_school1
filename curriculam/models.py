...
class Subject(models.Model):
    ...
    image=models.ImageField( blank=True, verbose_name='Subject Image')
    description=models.TextField(max_length=500,blank=True)
...
class Lession(models.Model):
    ...
    subject = models.ForeignKey(Subject, on_delete=models.CASCADE,related_name='lessions')
    ...
    def get_absolute_url(self):
        return reverse('curriculam:lession_list', kwargs={'slug':self.subject.slug, 'standard':self.Standard.slug})

class Comment(models.Model):
    lession_name = models.ForeignKey(Lession,null=True, on_delete=models.CASCADE,related_name='comments')
